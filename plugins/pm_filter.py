...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('Cнαηηєℓѕ', url='https://t.me/emotionmedia22'),
            ...
            InlineKeyboardButton('Jσιη Fσя Mσνιєѕ', url='https://t.me/amsmoviehub')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons= [[
            InlineKeyboardButton('♥️ Jσιη Fσя Mσνιєѕ ♥️', url='https://t.me/amsmoviehub')
            ],[
